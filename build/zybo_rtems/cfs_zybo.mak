...
cfs_build_static_link::
	@echo ""
	@echo ">>> [BUILD] BUILD STATIC LINK <<<"
	@echo ""
	$(MAKE) -C exe 
	@echo ">>> [BUILD] RELINK RKI IMAGE <<<"
	$(MAKE) -C rtems
...
cfs_install_core::
	@echo ""
	@echo ">>> [POST-BUILD] INSTALL CORE NOT NEEDED FOR LEON3<<<"
	@echo ""
	# $(MAKE) -C cfe install
...
cfs_install_apps::
	@echo ""
	@echo ">>> [POST-BUILD] INSTALL APPS NOT NEEDED FOR LEON3 <<<"
	@echo ""
	# @for app in $(THE_APPS); do                                     \
	#     $(MAKE) -C $${app} install                                  \
	#     || exit 1;                                                  \
...
#-------------------------------------------------------------------------------
# This is not needed for RTEMS LEON3 build
cfs_copy_installs::
	@echo ""
...
# only install app tbls is needed for LEON3/RTEMS build

cfs_postbuild:: cfs_install_app_tbls     
	@echo ""
	@echo ">>> DONE! <<<"
	@echo ""
